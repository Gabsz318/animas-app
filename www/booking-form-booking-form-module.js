...
/***/ "1ESP":
/*!*********************************************************!*\
  !*** ./src/app/bookings/booking-form/booking-fields.ts ***!
  \*********************************************************/
/*! exports provided: bookingFields */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "bookingFields", function() { return bookingFields; });
const bookingFields = [
    {
        label: 'Cliente',
        type: 'select',
...
/***/ "6mIf":
/*!**************************************************************!*\
  !*** ./src/app/bookings/booking-form/booking-form.page.scss ***!
  \**************************************************************/
...
/***/ "7Icc":
/*!**********************************************************************!*\
  !*** ./src/app/bookings/booking-form/booking-form-routing.module.ts ***!
  \**********************************************************************/
...
/* harmony import */ var _booking_form_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./booking-form.page */ "lYtN");
...
/***/ "VItk":
/*!**************************************************************!*\
  !*** ./src/app/bookings/booking-form/booking-form.module.ts ***!
  \**************************************************************/
...
/* harmony import */ var _booking_form_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./booking-form-routing.module */ "7Icc");
/* harmony import */ var _booking_form_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./booking-form.page */ "lYtN");
...
/***/ "lYtN":
/*!************************************************************!*\
  !*** ./src/app/bookings/booking-form/booking-form.page.ts ***!
  \************************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _raw_loader_booking_form_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! raw-loader!./booking-form.page.html */ "lvtq");
/* harmony import */ var _booking_form_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./booking-form.page.scss */ "6mIf");
...
/* harmony import */ var _booking_fields__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./booking-fields */ "1ESP");
/* harmony import */ var _capacitor_camera__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @capacitor/camera */ "/s3u");
/* harmony import */ var _capacitor_device__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @capacitor/device */ "rvvs");
/* harmony import */ var src_app_cabin_cabin_status__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! src/app/cabin/cabin-status */ "7f/p");
...
let BookingFormPage = class BookingFormPage {
    constructor(ngFirestore, route, router) {
        ...
        this.route = route;
        this.router = router;
        this.bookingFields = _booking_fields__WEBPACK_IMPORTED_MODULE_7__["bookingFields"];
        this.booking = {
            client_id: 1,
            start_date: '',
            end_date: '',
    ...
    loadData() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.ngFirestore
                ...
                .snapshotChanges()
                .subscribe((d) => {
                this.cabins = d.map((c) => (Object.assign({ id: c.payload.doc.id }, c.payload.doc.data())));
                this.bookingFields.find((f) => f.fieldName === 'cabin_id').options =
                    this.cabins
                        .filter((f) => f.status === src_app_cabin_cabin_status__WEBPACK_IMPORTED_MODULE_10__["CabinStatus"].Disponible)
                        .map((d) => ({
                        value: d.id,
                        label: d.cabin_name,
                        price: d.price,
    ...
    save() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            ...
            this.booking.start_date = this.removeDateCharacters(this.booking.start_date);
            this.booking.end_date = this.removeDateCharacters(this.booking.end_date);
            const fields = Object.keys(this.booking);
            const data = Object.values(this.booking);
            if (this.bookingId) {
                yield this.ngFirestore
                    .collection('bookings')
                    .doc(this.bookingId)
                    .update(this.booking);
            }
            ...
            this.cabins.find((d) => d.id === this.booking.cabin_id)['status'] = this
                .booking.voucher
                ? src_app_cabin_cabin_status__WEBPACK_IMPORTED_MODULE_10__["CabinStatus"].Reservada
                : src_app_cabin_cabin_status__WEBPACK_IMPORTED_MODULE_10__["CabinStatus"].Reservando;
    ...
    takeVoucher() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (!_capacitor_camera__WEBPACK_IMPORTED_MODULE_8__["Camera"]) {
                return;
            }
            const platform = (yield _capacitor_device__WEBPACK_IMPORTED_MODULE_9__["Device"].getInfo()).operatingSystem;
            let image;
            if (platform === 'windows') {
                this.imgUpload.nativeElement.click();
            }
            else {
                image = yield _capacitor_camera__WEBPACK_IMPORTED_MODULE_8__["Camera"].getPhoto({
                    quality: 75,
    ...
    dateChange() {
        this.booking.nights_quantity = moment__WEBPACK_IMPORTED_MODULE_6__(this.booking.end_date).diff(moment__WEBPACK_IMPORTED_MODULE_6__(this.booking.start_date), 'days');
        this.calculateTotal();
    }
    onChangeImage(args) {
...
BookingFormPage.propDecorators = {
    ...
    imgUpload: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_3__["ViewChild"], args: ['imgUpload', { static: false },] }]
};
...
/***/ "lvtq":
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/bookings/booking-form/booking-form.page.html ***!
  \****************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const Device = Object(_capacitor_core__WEBPACK_IMPORTED_MODULE_0__["registerPlugin"])('Device', {
    web: () => __webpack_require__.e(/*! import() | web */ "web").then(__webpack_require__.bind(null, /*! ./web */ "U6Qn")).then(m => new m.DeviceWeb()),
});
